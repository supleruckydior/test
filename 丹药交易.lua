...
totalPointsLabel.Position = UDim2.new(0.05, 0, 0, 45)
...
for i = 1, 5 do
    ...
    frame.Position = UDim2.new(0.05, 0, 0, 80 + (i-1)*75)
...
buttonFrame.Position = UDim2.new(0.05, 0, 0, 80 + 5*75)
...
statusLabel.Position = UDim2.new(0.05, 0, 0, 80 + 5*75 + 90)
